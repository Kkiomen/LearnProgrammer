...
namespace App\CoreErpAssistant\Api;
...
class OpenAiApi
{
    ...
    public function completionChat($message, $systemPrompt = null, OpenAiModel $model = null,  $settings = null): string
    {
        if(is_null($settings)){
            $settings = [
                'temperature' => 0.7
        ...
        $defaultParams = [
            'model' => $model->value ?? OpenAiModel::CHAT_GPT_3->value,
            'messages' => $messagesFormatted
        ];

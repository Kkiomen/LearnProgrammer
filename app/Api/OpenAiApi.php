...
class OpenAiApi
{
     ...
     * @return mixed The response generated by OpenAI
     */
    public function chat(string $prompt, OpenAiModel $model = null, string $systemPrompt = null, array $settings = null){
        $messagesFormatted = [];
        ...
        $messages = MessageHelper::getConversationMessages();

        $messagesFormatted[] = ['role' => 'system', 'content' => $systemPrompt];
        $messagesFormatted[] = ['role' => 'user', 'content' => $prompt];
        foreach ($messages as $message){
            $messagesFormatted[] = ['role' => 'user', 'content' => $message->message ?? ''];
            $messagesFormatted[] = ['role' => 'assistant', 'content' => $message->result ?? ''];
        }
        ...
        $response = $this->client->chat()->createStreamed($mergedParams);
        return $response;
    }
